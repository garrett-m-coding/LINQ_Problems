...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemEighteen()
        {
            ...
            Console.WriteLine("\n\n\n********* Problem Eighteen **********\n Deleted User Oda's customer role.");
        ...
        private void ProblemTwenty()
        {
            ...
            Console.WriteLine("\n\n\n********* Problem Twenty **********\n Deleted user Oda from database.");
        ...
        private void BonusOne()
        {
            ...
            Console.WriteLine("You entered email:     '{0}'", emailString);
            Console.WriteLine("Enter your password - ");
            passwordString = Console.ReadLine();
            Console.WriteLine("You entered password:     '{0}'", passwordString);
        }
